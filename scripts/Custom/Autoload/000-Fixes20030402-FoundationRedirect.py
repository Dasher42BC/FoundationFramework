...
# Written March 5, 2003 - a legacy file for reference purposes only.
...
#         else:
#             debug("ERROR:  Cannot get ship property for %s, check hardpoints!" % (pcScript))
#
...
#
#                 if ((kSpecies == App.SPECIES_GALAXY) and (sShipClass != "Galaxy")) or ((kSpecies == App.SPECIES_SOVEREIGN) and (sShipClass != "Sovereign")):

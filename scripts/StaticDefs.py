...
Foundation.ShipDef(
    "Unknown", App.SPECIES_UNKNOWN, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
...
Foundation.ShipDef.Sovereign = Foundation.SovereignDef(
    "Sovereign", App.SPECIES_SOVEREIGN, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.Ambassador = Foundation.FedShipDef(
    "Ambassador", App.SPECIES_AMBASSADOR, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.Shuttle = Foundation.ShipDef(
    "Shuttle", App.SPECIES_SHUTTLE, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "FedShuttle", "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.Transport = Foundation.ShipDef(
    "Transport", App.SPECIES_TRANSPORT, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.Freighter = Foundation.ShipDef(
    "Freighter", App.SPECIES_FREIGHTER, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.Keldon = Foundation.CardShipDef(
    "Keldon", App.SPECIES_KELDON, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.CardFreighter = Foundation.ShipDef(
    "CardFreighter", App.SPECIES_CARDFREIGHTER, {"modes": [Foundation.MutatorDef.StockShips], "name": "Card Freighter", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.CardFreighter.RegisterQBShipMenu("Card Ships", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.CardHybrid = Foundation.CardShipDef(
    "CardHybrid",
    App.SPECIES_CARDHYBRID,
    {"modes": [Foundation.MutatorDef.StockShips], "name": "Card Hybrid", "iconName": "Hybrid", "hasTGLName": 1, "hasTGLDesc": 1},
)
...
Foundation.ShipDef.Warbird = Foundation.RomulanShipDef(
    "Warbird", App.SPECIES_WARBIRD, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.BirdOfPrey = Foundation.KlingonShipDef(
    "BirdOfPrey", App.SPECIES_BIRD_OF_PREY, {"modes": [Foundation.MutatorDef.StockShips], "name": "BOP", "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.Vorcha = Foundation.KlingonShipDef(
    "Vorcha", App.SPECIES_VORCHA, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.KessokHeavy = Foundation.KessokShipDef(
    "KessokHeavy", App.SPECIES_KESSOK_HEAVY, {"modes": [Foundation.MutatorDef.StockShips], "name": "Kessok Heavy", "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.KessokLight = Foundation.KessokShipDef(
    "KessokLight", App.SPECIES_KESSOK_LIGHT, {"modes": [Foundation.MutatorDef.StockShips], "name": "Kessok Light", "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.KessokMine = Foundation.KessokShipDef(
    "KessokMine", App.SPECIES_KESSOKMINE, {"modes": [Foundation.MutatorDef.StockShips], "name": "Kessok Mine", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.KessokMine.RegisterQBShipMenu("Other Ships", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.Marauder = Foundation.FerengiShipDef(
    "Marauder", App.SPECIES_MARAUDER, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.FedOutpost = Foundation.StarBaseDef(
    "FedOutpost", App.SPECIES_FED_OUTPOST, {"modes": [Foundation.MutatorDef.StockShips], "name": "Fed Outpost", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.FedOutpost.RegisterQBShipMenu("Bases", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.FedStarbase = Foundation.StarBaseDef(
    "FedStarbase", App.SPECIES_FED_STARBASE, {"modes": [Foundation.MutatorDef.StockShips], "name": "Fed Starbase", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.FedStarbase.RegisterQBShipMenu("Bases", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.CardStarbase = Foundation.CardStarBaseDef(
    "CardStarbase", App.SPECIES_CARD_STARBASE, {"modes": [Foundation.MutatorDef.StockShips], "name": "Card Starbase", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.CardStarbase.RegisterQBShipMenu("Bases", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.CardOutpost = Foundation.CardStarBaseDef(
    "CardOutpost", App.SPECIES_CARD_OUTPOST, {"modes": [Foundation.MutatorDef.StockShips], "name": "Card Outpost", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.CardOutpost.RegisterQBShipMenu("Bases", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.CardStation = Foundation.CardStarBaseDef(
    "CardStation", App.SPECIES_CARD_STATION, {"modes": [Foundation.MutatorDef.StockShips], "name": "Card Station", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.CardStation.RegisterQBShipMenu("Bases", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.Drydock = Foundation.StarBaseDef(
    "DryDock", App.SPECIES_DRYDOCK, {"modes": [Foundation.MutatorDef.StockShips], "name": "Dry Dock", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.Drydock.RegisterQBShipMenu("Bases", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.SpaceFacility = Foundation.StarBaseDef(
    "SpaceFacility", App.SPECIES_SPACE_FACILITY, {"modes": [Foundation.MutatorDef.StockShips], "name": "Space Facility", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.SpaceFacility.RegisterQBShipMenu("Bases", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.CommArray = Foundation.StarBaseDef(
    "CommArray", App.SPECIES_COMMARRAY, {"modes": [Foundation.MutatorDef.StockShips], "name": "Comm Array", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.CommArray.RegisterQBShipMenu("Other Ships", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.CommLight = Foundation.ShipDef(
    "CommLight", App.SPECIES_COMMLIGHT, {"modes": [Foundation.MutatorDef.StockShips], "name": "Comm Light", "hasTGLName": 1, "hasTGLDesc": 1}
)
...
Foundation.ShipDef.ProbeType2 = Foundation.ShipDef(
    "ProbeType2", App.SPECIES_PROBETYPE2, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)

Foundation.ShipDef.Asteroid = Foundation.ShipDef(
    "Asteroid", App.SPECIES_ASTEROID, {"modes": [Foundation.MutatorDef.StockShips], "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.Asteroid.RegisterQBShipMenu("Other Ships", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.SunBuster = Foundation.ShipDef(
    "Sunbuster", App.SPECIES_SUNBUSTER, {"modes": [Foundation.MutatorDef.StockShips], "name": "Sun Buster", "hasTGLName": 1, "hasTGLDesc": 1}
)
Foundation.ShipDef.SunBuster.RegisterQBShipMenu("Other Ships", mode=Foundation.MutatorDef.StockShips)

Foundation.ShipDef.EscapePod = Foundation.ShipDef(
    "EscapePod",
    App.SPECIES_ESCAPEPOD,
    {"modes": [Foundation.MutatorDef.StockShips], "name": "Escape Pod", "iconName": "LifeBoat", "hasTGLName": 1, "hasTGLDesc": 1},
)
...
Foundation.ShipDef.Amagon = Foundation.ShipDef(
    "Amagon", App.SPECIES_ASTEROID, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "Asteroid", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message
...
Foundation.ShipDef.BiranuStation = Foundation.ShipDef(
    "BiranuStation", App.SPECIES_ASTEROID, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "SpaceFacility", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message
...
Foundation.ShipDef.BombFreighter = Foundation.ShipDef(
    "BombFreighter", App.SPECIES_CARDFREIGHTER, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "CardFreighter", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message
...
Foundation.ShipDef.E2M0Warbird = Foundation.ShipDef(
    "E2M0Warbird", App.SPECIES_WARBIRD, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "Warbird", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message
...
Foundation.ShipDef.Enterprise = Foundation.ShipDef(
    "Enterprise", App.SPECIES_SOVEREIGN, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "Sovereign", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message
...
Foundation.ShipDef.Geronimo = Foundation.ShipDef(
    "Geronimo", App.SPECIES_AKIRA, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "Akira", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message
...
Foundation.ShipDef.MatanKeldon = Foundation.ShipDef(
    "MatanKeldon", App.SPECIES_KELDON, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "Keldon", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message
...
Foundation.ShipDef.Peregrine = Foundation.ShipDef(
    "Peregrine", App.SPECIES_NEBULA, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "Nebula", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message
...
Foundation.ShipDef.RanKuf = Foundation.ShipDef(
    "RanKuf", App.SPECIES_BIRD_OF_PREY, {"modes": [Foundation.MutatorDef.StockShips], "iconName": "BirdOfPrey", "hasTGLName": 1, "hasTGLDesc": 1}
)
# Revise the destroyed message

...
# import Custom.FTB.Framework.SecondaryTargetting
...
MAIN_PANE_X_POS = 0.0300000
MAIN_PANE_Y_POS = 0.0300000
MAIN_PANE_WIDTH = 0.9400000
MAIN_PANE_HEIGHT = 0.9400000
TOP_STYLIZED_X_POS = 0.0000000
TOP_STYLIZED_Y_POS = 0.0000000
TOP_STYLIZED_WIDTH = 0.9400000
TOP_STYLIZED_HEIGHT = 0.0950000

SHIPS_BUTTON_X_POS = 0.0100000
SHIPS_BUTTON_Y_POS = 0.0000000
SHIPS_BUTTON_WIDTH = 0.2500000
SHIPS_BUTTON_HEIGHT = 0.0350000

PLAYER_BUTTON_X_POS = 0.2700000
PLAYER_BUTTON_Y_POS = 0.0000000
PLAYER_BUTTON_WIDTH = 0.2500000
PLAYER_BUTTON_HEIGHT = 0.0350000

CLOSE_BUTTON_X_POS = 0.7700000
CLOSE_BUTTON_Y_POS = 0.0000000
CLOSE_BUTTON_WIDTH = 0.1500000
CLOSE_BUTTON_HEIGHT = 0.0350000

SUB_PANE_X_POS = 0.0000000
SUB_PANE_Y_POS = 0.1000000
SUB_PANE_WIDTH = 0.9400000
SUB_PANE_HEIGHT = 0.8400000

SHIP_MENU_X_POS = 0.0000000
SHIP_MENU_Y_POS = 0.0000000
SHIP_MENU_WIDTH = 0.2300000
SHIP_MENU_HEIGHT = 0.8400000

BAR_X_POS = 0.2300000
BAR_Y_POS = 0.0000000
BAR_WIDTH = 0.2700000
BAR_HEIGHT = 0.0290000

SHIP_IMAGE_X_POS = 0.2400000
SHIP_IMAGE_Y_POS = 0.0300000
SHIP_IMAGE_WIDTH = 0.2600000
SHIP_IMAGE_HEIGHT = 0.2600000

SHIPS_TEXT_X_POS = 0.2400000
SHIPS_TEXT_Y_POS = 0.2950000
SHIPS_TEXT_WIDTH = 0.2600000
SHIPS_TEXT_HEIGHT = 0.2850000

ADD_FRIEND_BUTTON_X_POS = 0.2400000
ADD_FRIEND_BUTTON_Y_POS = 0.5850000
ADD_FRIEND_BUTTON_WIDTH = 0.2600000
ADD_FRIEND_BUTTON_HEIGHT = 0.1200000

ADD_ENEMY_BUTTON_X_POS = 0.2400000
ADD_ENEMY_BUTTON_Y_POS = 0.7100000
ADD_ENEMY_BUTTON_WIDTH = 0.2600000
ADD_ENEMY_BUTTON_HEIGHT = 0.1200000

AI_MENU_X_POS = 0.2400000
AI_MENU_Y_POS = 0.9990000
AI_MENU_WIDTH = 0.2600000
AI_MENU_HEIGHT = 0.1650000

FRIEND_LIST_X_POS = 0.5100000
FRIEND_LIST_Y_POS = 0.0000000
FRIEND_LIST_WIDTH = 0.2100000
FRIEND_LIST_HEIGHT = 0.7600000

ENEMY_LIST_X_POS = 0.7300000
ENEMY_LIST_Y_POS = 0.0000000
ENEMY_LIST_WIDTH = 0.2100000
ENEMY_LIST_HEIGHT = 0.7600000

DOWN_BUTTON_X_POS = 0.5100000
DOWN_BUTTON_Y_POS = 0.7650000
DOWN_BUTTON_WIDTH = 0.2100000
DOWN_BUTTON_HEIGHT = 0.0300000

UP_BUTTON_X_POS = 0.7300000
UP_BUTTON_Y_POS = 0.7650000
UP_BUTTON_WIDTH = 0.2100000
UP_BUTTON_HEIGHT = 0.0300000

DEL_BUTTON_X_POS = 0.5100000
DEL_BUTTON_Y_POS = 0.8000000
DEL_BUTTON_WIDTH = 0.4300000
DEL_BUTTON_HEIGHT = 0.0300000

PLAYER_TEXT_X_POS = 0.2400000
PLAYER_TEXT_Y_POS = 0.2950000
PLAYER_TEXT_WIDTH = 0.2600000
PLAYER_TEXT_HEIGHT = 0.2850000

BRIDGE_MENU_X_POS = 0.2400000
BRIDGE_MENU_Y_POS = 0.5850000
BRIDGE_MENU_WIDTH = 0.2600000
BRIDGE_MENU_HEIGHT = 0.2550000

REGION_MENU_X_POS = 0.5100000
REGION_MENU_Y_POS = 0.0000000
REGION_MENU_WIDTH = 0.4320000
REGION_MENU_HEIGHT = 0.8400000
...
def BuildDialog(bPreservePane=0):
    ...
    pStylizedWindow = App.STStylizedWindow_CreateW(
        "StylizedWindow",
        "NoMinimize",
        g_pMissionDatabase.GetString("QuickBattle Configuration"),
        0.0,
        0.0,
        None,
        1,
    ...
    global g_pPlayerButton
    g_pPlayerButton = CreateBridgeMenuButton(
        g_pMissionDatabase.GetString("Player and Region"), ET_OPEN_PLAYER_PANE, 0, g_pXO, PLAYER_BUTTON_WIDTH, PLAYER_BUTTON_HEIGHT
    )
    ...
    global g_pAddFriendButton
    g_pAddFriendButton = CreateBridgeMenuButton(
        g_pMissionDatabase.GetString("Add Friend"), ET_ADD_AS_FRIEND, 0, g_pXO, ADD_FRIEND_BUTTON_WIDTH, ADD_FRIEND_BUTTON_HEIGHT
    )
    ...
    global g_pAddEnemyButton
    g_pAddEnemyButton = CreateBridgeMenuButton(
        g_pMissionDatabase.GetString("Add Enemy"), ET_ADD_AS_ENEMY, 0, g_pXO, ADD_ENEMY_BUTTON_WIDTH, ADD_ENEMY_BUTTON_HEIGHT
    )
    ...
    global g_pFriendToEnemyButton
    g_pFriendToEnemyButton = CreateBridgeMenuButton(
        g_pMissionDatabase.GetString("Down"), ET_CHANGE_FRIEND_TO_ENEMY, 0, g_pXO, DOWN_BUTTON_WIDTH, DOWN_BUTTON_HEIGHT
    )
    ...
    global g_pShipsText
    g_pShipsText = App.TGParagraph_Create(
        "",
        pStylizedWindow.GetMaximumInteriorWidth(),
        None,
        "",
        pStylizedWindow.GetMaximumInteriorWidth(),
    ...
    global g_pPlayerText
    g_pPlayerText = App.TGParagraph_Create(
        "",
        pStylizedWindow.GetMaximumInteriorWidth(),
        None,
        "",
...
def GenerateEnemyMenu():
    ...
    g_pEnemyWindow.SetTitleBarThickness(BAR_HEIGHT)
...
def GenerateFriendMenu():
    ...
    g_pFriendWindow.SetTitleBarThickness(BAR_HEIGHT)
...
def UpdateIcon(iIconNumber, pIcon, pPane):
    ...
    iconHeight = pIcon.GetHeight()

    # If we're too big, shrink us down
    if iconHeight and iconHeight > pPane.GetHeight():
        fRatio = pPane.GetHeight() / iconHeight
        pIcon.Resize(pIcon.GetWidth() * fRatio * 0.9, iconHeight * fRatio * 0.9)

    # Center us in our parent pane
    fXPos = (pPane.GetWidth() - pIcon.GetWidth()) / 2.0
    fYPos = (pPane.GetHeight() - iconHeight) / 2.0
...
def ChangeRegion():
    ...
    bDupeRegion = 0
    if (
        g_sSelectedRegion == "Sol1"
        or g_sSelectedRegion == "Cebalrai1"
        or g_sSelectedRegion == "Vesuvi5"
        or g_sSelectedRegion == "Vesuvi6"
        or g_sSelectedRegion == "Belaruz4"
    ):
        bDupeRegion = 1
...
###############################################################################
def GenerateShips():
    global g_iNumFriends, g_iNumEnemies
    global pEnemies
    global pFriendlies
    g_iNumFriends = 0
    g_iNumEnemies = 0
    ...
    for kShipData in kShipList:
        ...
        pShip = loadspacehelper.CreateShip(sShipType, g_pSet, sShipName, "", sShipRef)
        if App.IsNull(pShip):
...
def RecreatePlayer():
    ...
    if pTorpSys:
        # Forcibly unload all torps past quantums (Type 2)

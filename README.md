...
This software has from the beginning been distributed under the terms of the LGPL license, v2.1 being current at the time of its writing.  Any inclusion of any of this project's files while omitting the readme, the license information or reference to it, or all source code - included or available - necessary for a complete build is violating the license, as well as disrupting the conditions needed for coders to correctly integrate and debug diverse work.  Without this, or literacy in why LGPL software is *not* freeware, this software is getting misused in ways that impact the entire ecosystem.  This misuse benefits plagiarists, and defaces the work of coders who built on this base.

Auto-loading third-party Python plugins, which some mistakenly think is the sole purpose of this class library, has also proven to be this project's undoing.  The whole Python layer's namespace is open to all; a single file injecting buggy or obsolete code auto-loaded from anywhere can undo all maintenance to this library.  Giving full privilege to all code and patches alike means any code release can potentially break any other, including the Foundation Framework itself.  
